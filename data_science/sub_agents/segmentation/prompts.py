...
def return_instructions_bigquery() -> str:
    ...
    instruction_prompt_bqml_v1 = f"""
      You are an AI assistant performing segmentation and activations.
      ...
      3a. Ask user when user wants to activate the results to GCS.
      3b. You should use activate the SQL you have created for syntax and function errors (Use run_bq_gcs_activation tool). Please provide destination_blob_name and sql query in text format to the tool. If there are any errors, you should go back and address the error in the SQL. Recreate the SQL based by addressing the error.
